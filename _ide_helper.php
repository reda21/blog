 ...
 * Generated for Laravel 6.16.0 on 2020-02-19 11:47:38.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Route {
        ...
        {
                        return \Illuminate\Routing\Router::widget($url, $widget, $name);
        }
        ...
        {
                        return \Illuminate\Routing\Router::jsonWidget($url, $widget, $name);
        }
